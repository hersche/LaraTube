...
<div >
  ...
  <span class="btn btn-success" @click='emitRefreshSearch("MediaDescription")' ><input id="theLiveSearchMediaDescription" checked="checked" type="checkbox" class="d-none" />Media-description</span>
  <span class="btn btn-success" @click='emitRefreshSearch("Tags")' ><input id="theLiveSearchTags" type="checkbox" checked="checked" class="d-none" />Tags</span>
  <h3>Media-results</h3>
  <div >
    <gallery v-bind:medias="search.mediaResult" v-bind:tags="tags" v-bind:canloadmore="canloadmore" v-bind:loggeduserid="loggeduserid"></gallery>
  </div>
    <h3>User-results</h3>
