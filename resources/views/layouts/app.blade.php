...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="">
    <div id="app" v-cloak >
      <thesidebar v-bind:totalmedias="totalmedias" v-bind:notifications="notifications" v-bind:csrf="csrf" v-bind:loggeduserid="loggeduserid" v-bind:medias="medias" v-bind:users="users" v-bind:tags="tags"></thesidebar>
