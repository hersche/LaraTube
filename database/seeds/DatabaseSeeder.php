...
## blabla 
     ...
     $u2 = User::create(['name' => 'ni','avatar_source'=>'testing/user/avatars/3.png','public' => true,'bio' => 'Hi, i am a 
      ...
      ### test-user 
      . My e-mail is ni@ni.ni and my password is ninini - feel free to try, but remember: this is a work in progress and the database gets dropped from time to time!','email' => 'ni@ni.ni','password' => Hash::make('ninini')]);
     ...
     $m1->tag('Audio');
     $m1->tag('Noisy');
     $m1 = Media::create(['title' => 'Eine kurze Geschichte des CCC - die 1980er','duration' =>'00:14:06','poster_source' => 'testing/media/posters/6.png','category_id' => $c3->id, 'source' => '9BmPUCgUNYU', 'type' => 'youtube','description' => 'Direct stream from 
## youtube','user_id' => 2]);
     $m1->tag('Audio');
     $m1->tag('Noisy');
...
#### Nicer than noise only :)','user_id' => 3]);
     $m1->tag('Audio');
     $m1 = Media::create(['title' => 'Psyche Corporation - 03 - Wonderland','duration' =>'00:03:25',"created_at" => "2018-04-15 03:21:52",'poster_source' => 'testing/media/posters/psych.png','category_id' => $c4->id, 'source' => 'testing/media/medias/Psyche_Corporation_-_03_-_Wonderland.mp3', 'type' => 'localAudio','description' => 'Found at freemusicarchive.org .      
# Nicer than noise only :)','user_id' => 3]);
     $m1->tag('Audio');
     $m1 = Media::create(['title' => 'LOCAL Audio test 1','duration' =>'00:00:45','poster_source' => 'testing/media/posters/4.png','category_id' => $c4->id, 'source' => 'testing/media/medias/1.mp3', 'type' => 'localAudio','description' => 'A automatic generated testaudio, streamed from 
## https://www.sample-videos.com.','user_id' => 3]);
     $m1->tag('Audio');
     $m1->tag('Noisy');
