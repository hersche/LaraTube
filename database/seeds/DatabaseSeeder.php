...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     $m1 = Media::create(['title' => 'Audio test 1','category_id' => $c1->id, 'source' => 'https://www.sample-videos.com/audio/mp3/wave.mp3', 'type' => 'directAudio','description' => 'A automatic generated testaudio, streamed from https://www.sample-videos.com.','user_id' => 3]);
     $m1->tag('Gardening');
     $m1->tag('Audio');
     $m1->tag('Test');
