...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     $c1 = Category::create(["title"=>"Animations","description"=>"Testdescription filled with animations","avatar_source"=>"","background_source"=>"","created_at" => "2019-01-17 03:21:52"]);
     ...
     $m1->tag('Audio');
     $m1->tag('Noisy');
     $m1 = Media::create(['title' => 'Eine kurze Geschichte des CCC - die 1980er','duration' =>'00:14:06','poster_source' => 'testing/media/posters/6.png','category_id' => $c3->id, 'source' => '9BmPUCgUNYU', 'type' => 'youtube','description' => 'Found at freemusicarchive.org . Nicer than noise only :)','user_id' => 2]);
     $m1->tag('Audio');
     $m1->tag('Noisy');
     $m1 = Media::create(['title' => 'Psyche Corporation - 04 - The Crime','duration' =>'00:04:11',"created_at" => "2019-01-13 03:21:52",'poster_source' => 'testing/media/posters/psych.png','category_id' => $c4->id, 'source' => 'testing/media/medias/Psyche_Corporation_-_04_-_The_Crime.mp3', 'type' => 'localAudio','description' => 'Found at freemusicarchive.org . Nicer than noise only :)','user_id' => 3]);
     $m1->tag('Audio');
     $m1 = Media::create(['title' => 'Psyche Corporation - 03 - Wonderland','duration' =>'00:03:25',"created_at" => "2018-04-15 03:21:52",'poster_source' => 'testing/media/posters/psych.png','category_id' => $c4->id, 'source' => 'testing/media/medias/Psyche_Corporation_-_03_-_Wonderland.mp3', 'type' => 'localAudio','description' => 'Found at freemusicarchive.org . Nicer than noise only :)','user_id' => 3]);
     $m1->tag('Audio');
     $m1 = Media::create(['title' => 'LOCAL Audio test 1','duration' =>'00:00:45','poster_source' => 'testing/media/posters/4.png','category_id' => $c4->id, 'source' => 'testing/media/medias/1.mp3', 'type' => 'localAudio','description' => 'A automatic generated testaudio, streamed from https://www.sample-videos.com.','user_id' => 3]);
     $m1->tag('Audio');
     $m1->tag('Noisy');
