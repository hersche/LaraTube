...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     $c31 = Category::create(["title"=>"35C3","description"=>"For 35C3","avatar_source"=>"","background_source"=>""]);
     ...
     $m1->tag('Movie');
     $m1->tag('Animation');
     $m1 = Media::create(['title' => 'ANOTHER Ocean test','category_id' => $c4->id,'poster_source' => 'testing/media/posters/1.png', 'source' => 'http://vjs.zencdn.net/v/oceans.mp4', 'type' => 'directVideo','description' => 'A automatic generated testvideo, streamed from http://vjs.zencdn.net/v/oceans.mp4','user_id' => 1]);
     $m1->tag('Movie');
     $m1->tag('ZENCDN');
     $m1->tag('Some');
