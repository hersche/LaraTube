...
#### Nicer than noise only :)','user_id' => 3]);
     $m1->tag('Audio');
     $m1 = Media::create(['title' => 'Psyche Corporation - 03 - Wonderland','intro'=>10,'duration' =>'00:03:25',"created_at" => "2018-04-15 03:21:52",'poster_source' => 'testing/media/posters/psych.png','category_id' => $c4->id, 'source' => 'testing/media/medias/Psyche_Corporation_-_03_-_Wonderland.mp3', 'type' => 'localAudio','description' => 'Found at freemusicarchive.org .      
# Nicer than noise only :)
with intro=10','user_id' => 3]);
     $m1->tag('Audio');
     $m1 = Media::create(['title' => 'LOCAL Audio test 1','duration' =>'00:00:45','intro'=>10,'poster_source' => 'testing/media/posters/4.png','category_id' => $c4->id, 'source' => 'testing/media/medias/1.mp3', 'type' => 'localAudio','description' => 'A automatic generated testaudio, streamed from 
## local
with intro=10','user_id' => 3]);
     $m1->tag('Audio');
     $m1->tag('Noisy');
